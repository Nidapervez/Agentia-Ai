...
import { FaCogs, FaNetworkWired, FaLock } from "react-icons/fa";
  ...
  const solutions = [
    {
      icon: FaCogs,
      title: "Enterprise AI",
      description: "Tailor-made AI agents optimized for large-scale operations and data-driven decision-making.",
    },
    {
      icon: FaNetworkWired,
      title: "Neural Automation",
      description: "Advanced neural systems that streamline workflows, enhancing efficiency and adaptability.",
    },
    {
      icon: FaLock,
      title: "Secure Intelligence",
      description: "Privacy-focused AI solutions fortified with cutting-edge encryption and security layers.",
    },
  ];

  return (
    <div id="ai-solutions" className="min-h-screen flex flex-col items-center justify-start bg-black text-white px-6 py-32 md:py-40 relative">
      ...
      <p className="text-lg sm:text-xl text-gray-400 mt-4 max-w-3xl text-center">
        Revolutionizing industries with intelligent automation and adaptive AI agents.
      </p>

      {/* AI Solution Cards */}
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl relative z-10">
        {solutions.map((solution, index) => (
          ...
          >
            ...
            <solution.icon className="w-16 h-16 text-blue-400 drop-shadow-lg mb-4" />
            <h3 className="text-2xl font-semibold text-blue-300">{solution.title}</h3>
