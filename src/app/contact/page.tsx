...
export default function ContactForm() {
  ...
  return (
    <div id="contact" className="min-h-screen flex flex-col items-center justify-center bg-black text-white px-6 py-16">
      <h2 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-blue-400 via-cyan-500 to-blue-600 text-transparent bg-clip-text text-center">
        Get in Touch
      </h2>
      ...
      >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          type="submit"
          className="mt-6 w-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold py-4 rounded-lg shadow-lg transition-all duration-300 hover:shadow-2xl"
        >
          Send Message
        </motion.button>
      </motion.form>
